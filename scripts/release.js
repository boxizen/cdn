...
const cwd = "/home/travis/build/boxizen/cdn";
const api = `https://api.github.com/repos/boxizen/cdn/releases`;
...
async function start() {
  try {
    ...
    await Git.remote(cwd, ["add", "gh-pages", "https://github.com/boxizen/cdn.git"]);
    ...
    try {
      await Git.push(cwd, ["-q", `https://${TOKEN}@github.com/boxizen/cdn`, "gh-pages/gh-pages", "--tags"]);      
    } catch(e) {}
